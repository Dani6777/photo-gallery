...
import { Preferences } from '@capacitor/preferences'; // Importa Preferences desde Capacitor
...
export function usePhotoGallery() {
    ...
    const loadSaved = async () => {
      ...
      };// Dependencia vacía para cargar las fotos solo una vez al montar el componente
